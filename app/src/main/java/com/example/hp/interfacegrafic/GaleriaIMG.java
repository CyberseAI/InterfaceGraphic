...
public class GaleriaIMG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_img);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_galeria_img, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment implements OnLoadCompleImg{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_galeria_img, container, false);

            ImageView img = (ImageView)rootView.findViewById(R.id.imgGallery);
